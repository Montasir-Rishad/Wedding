<?php
	...
	if($rn){
		echo "<h5 style='color:green; padding:10px;'>বায়োডাটা সফলভাবে আপডেট হয়েছে</h5>";
	}
	else{
		echo "<h5 style='color:red; padding:10px;'>দুঃখিত, বায়োডাটা আপডেট সফল হয়নি। কিছুক্ষণ পির পুনঃরায় পুরণ করুন।</h5>";	
	}
?>